        ...
        <div className="mt-6 grid gap-8 lg:grid-cols-2">
          <div>
            ...
            {educationExperiences.length > 0 ? (
              ...
              <p className="rounded-xl border border-dashed border-slate-200 p-4 text-slate-400">등록된 학력·교육 정보가 없습니다.</p>
            )}
          </div>
          ...
          <div>
            ...
            {certificateExperiences.length > 0 ? (
              ...
              <p className="rounded-xl border border-dashed border-slate-200 p-4 text-slate-400">등록된 자격증 정보가 없습니다.</p>
            )}
          </div>
        </div>
      </div>
