                    ...
                    <div className="col-span-12 lg:col-span-5 flex flex-col h-full overflow-hidden bg-white">
                        ...
                        <div className="flex items-center justify-between border-b border-slate-100 px-5 py-3.5 bg-indigo-50/50 shrink-0">
                            ...
                            <button
                                ...
                                className="flex items-center gap-1.5 rounded-xl border border-indigo-200 bg-white px-3 py-2 text-xs font-extrabold text-indigo-600 transition hover:bg-indigo-50 disabled:opacity-50 whitespace-nowrap shrink-0 shadow-xs"
                            >
                                {isGenerating ? (
                        ...
                        <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-slate-50/30">
                            ...
                            {isGenerating && (
                                <div className="flex gap-2.5 justify-start animate-pulse">
                                    ...
                                    <div className="rounded-2xl rounded-bl-none border border-indigo-100 bg-indigo-50/80 p-3.5 text-xs text-indigo-700 flex items-center gap-2 font-semibold">
                        ...
                        <div className="border-t border-slate-200 p-3.5 bg-white shrink-0">
                            ...
                            >
                                <input
                                    ...
                                    className="flex-1 min-w-0 rounded-xl border border-slate-200 bg-slate-50 px-4 py-2.5 text-xs text-slate-800 focus:border-indigo-500 focus:bg-white focus:outline-none transition font-medium"
                                />
                                <button
                                    type="submit"
                                    disabled={isGenerating || !feedbackInput.trim()}
                                    className="flex items-center gap-1.5 rounded-xl bg-amber-600 px-4 py-2.5 text-xs font-extrabold text-white transition hover:bg-amber-700 disabled:opacity-40 disabled:cursor-not-allowed shrink-0 whitespace-nowrap shadow-sm"
                                >
                                    {isGenerating ? (
                                        <Loader2 className="h-4 w-4 animate-spin shrink-0" />
                                    ) : (
