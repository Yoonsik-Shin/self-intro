...
import { colorForPriority } from '@/lib/constants/learningResourceColors';
...
export function LearningResourceGraphNode({ data }: NodeProps<LearningResourceGraphFlowNode>) {
    const color = colorForPriority(data.priorityTier);
    ...
    return (
        <div className="relative" style={{ width: diameter, height: diameter }}>
            ...
            <div
                className="h-full w-full cursor-pointer rounded-full shadow-md ring-2 ring-white transition-transform hover:scale-110"
