                            ...
                            <div className="flex items-center justify-between gap-4">
                                ...
                                >
                                    <div className="flex flex-wrap items-center gap-2">
                                        ...
                                        <span
                                            className={`inline-flex items-center gap-1 rounded border px-1.5 py-0.5 text-xs font-bold ${exp.showOnTimeline ? 'border-emerald-100 bg-emerald-50 text-emerald-700' : 'border-slate-200 bg-slate-50 text-slate-400'}`}
                                        >
                                            {exp.showOnTimeline ? (
