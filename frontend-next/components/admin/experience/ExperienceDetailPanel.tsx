            ...
            <div className="border-b border-slate-200 bg-slate-50/70 px-5 py-4 sm:px-7">
                <div className="flex flex-wrap items-center justify-between gap-3">
                    ...
                    >
                        ...
                        {parentExperience ? (
                            <span>
                                <b className="font-extrabold text-slate-900 group-hover:underline">
                ...
                <div className="mt-6 max-w-5xl">
                    ...
                    {experience.summary && (
                        <div className="mt-4 text-sm font-medium leading-relaxed text-slate-600 sm:text-base">
                            <ReactMarkdown components={adminDetailMarkdownComponents}>
                                {experience.summary}
                            </ReactMarkdown>
                        </div>
                    )}
                                                    ...
                                                    <div className="ml-9 mt-4 space-y-4 border-t border-slate-100 pt-3">
                                                        ...
                                                        {project.takeaway && (
                                                            <div className="rounded-xl border border-emerald-100 bg-emerald-50/40 p-3">
                                                                <h5 className="text-[11px] font-black uppercase tracking-wider text-emerald-700">
                                                                    핵심 성과 & 배운 점
                                                                </h5>
                            ...
                            <div className="space-y-3">
                                {experience.details
                                    ...
                                    .map(({ detail, index }) => {
                                        ...
                                        const merged =
                                            detail.narrative ||
                                            [detail.situation, detail.actionDetail, detail.outcome]
                                                .filter(Boolean)
                                                .join('\n\n');
                                        const hasContent =
                                                        ...
                                                        {detail.skills.length > 0 && (
                                                            <div className="mt-3 flex flex-wrap gap-1.5">
                                                                {detail.skills.map((skill) => (
                                                                    <span
                                                                        key={skill.id}
                                                                        className="rounded bg-slate-100 px-2 py-1 text-xs font-bold text-slate-600"
                                                                    >
                                                                        {skill.name}
                                                                    </span>
                                                                ))}
                    ...
                    {experience.type === 'PROJECT' && (
                        <section className="rounded-xl border border-slate-200 p-3">
                            ...
                            {experience.repositoryUrl && (
                                ...
                                >
                                    <Github className="h-3.5 w-3.5" /> GitHub 저장소{' '}
                                    <ExternalLink className="h-3 w-3" />
                                </a>
                            )}
                        </section>
