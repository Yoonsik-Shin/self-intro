...
import { Blocks, BookOpenCheck, Bot, BriefcaseBusiness, CloudCog, Code2, Database, FolderKanban, Shapes } from 'lucide-react';
...
export const skillUsagePresentations: Record<string, { label: string; Icon: LucideIcon; className: string }> = {
  WORK_EXPERIENCE: {
    label: '실무 경험',
