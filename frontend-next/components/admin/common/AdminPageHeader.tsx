    ...
    return (
        ...
        >
            <div className="min-w-0">
                <div className={compact ? 'flex min-w-0 items-center gap-2.5' : ''}>
                    {eyebrow && (
                        <p
                            className={`shrink-0 font-semibold uppercase leading-none text-indigo-600 ${
                                compact
                    ...
                    <div
                        className={`flex min-w-0 items-center gap-1.5 ${eyebrow && !compact ? 'mt-1.5' : ''}`}
                    >
                        <Heading
