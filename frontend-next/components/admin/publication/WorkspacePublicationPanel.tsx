                        ...
                        <div className="min-w-0">
                            ...
                            {statusQuery.isLoading ? (
                                <p className="mt-2 flex items-center gap-2 text-sm font-bold text-slate-500">
                                    <LoaderCircle className="h-4 w-4 animate-spin" /> 상태 확인 중
                                </p>
                                ...
                                <>
                                    ...
                                    <p className="mt-1 text-xs font-semibold text-emerald-800/80">
                                        {publishedAt ?? '발행 시각 정보 없음'} · 방문자는 이 불변
                                        snapshot을 봅니다.
                                    </p>
                                </>
                                ...
                                <>
                                    ...
                                    <p className="mt-1 text-xs font-semibold text-slate-600">
                                        최근 발행본 v{status.revisionNumber}은 보존 중이지만 방문자
                                        URL에는 노출되지 않습니다.
                                    </p>
                                </>
                            ) : (
                                <>
                                    ...
                                    <p className="mt-1 text-xs font-semibold text-slate-600">
                                        첫 버전을 발행하기 전까지 방문자 URL에는 콘텐츠가 노출되지
                                        않습니다.
                                    </p>
                                </>
                            )}
