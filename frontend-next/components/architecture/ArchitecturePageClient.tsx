...
const DEFAULT_SUBHEADING = '이 포트폴리오 웹앱의 도메인 모듈 구조, DB 데이터 관리 방식, 그리고 Cloudflare·오라클 Free Tier 기반 배포 인프라까지 담은 설계 명세입니다.';
  ...
  return (
    <div className="relative mx-auto max-w-[1500px] px-4 py-6 sm:px-6 lg:px-8">
      ...
      >
        ...
        <SectionNavSidebar sections={architectureSections} isCollapsed={isSectionNavCollapsed} onToggleCollapse={() => setIsSectionNavCollapsed((collapsed) => !collapsed)} />
      </div>
    </div>
  );
}
