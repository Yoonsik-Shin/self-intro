...
import type { AdminDonationSummary, DonationCreateResponse, DonationEvent, DonationStatus } from './types';
...
export const donationApi = {
  ...
  adminCancel: (id: number) => request<void>(`/api/admin/donations/${id}/cancel`, { method: 'POST' }),
};
