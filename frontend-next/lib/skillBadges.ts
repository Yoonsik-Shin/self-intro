export type SkillBadgeOption = {
  ...
  color: string;
  aliases: string[];
  // Simple Icons(cdn.simpleicons.org)에 브랜드가 아예 없는 경우(주로 AWS/Microsoft/Java/Playwright/OpenAI
  // 등 상표 이슈로 빠진 브랜드)의 대체 아이콘. 있으면 이 URL을 그대로 쓰고 색상 파라미터는 적용하지 않는다
  // (이미 실제 브랜드 컬러의 완성된 SVG라 단색화하면 오히려 원본보다 어색해진다).
  iconUrl?: string;
};

export const skillBadgeOptions: SkillBadgeOption[] = [
  { key: 'java', label: 'Java', color: 'ED8B00', aliases: ['java'], iconUrl: 'https://api.iconify.design/logos:java.svg' },
  ...
  { key: 'grpc', label: 'gRPC', color: '244C5A', aliases: ['grpc'], iconUrl: 'https://api.iconify.design/logos:grpc.svg' },
  { key: 'microsoftazure', label: 'Microsoft Azure', color: '0078D4', aliases: ['azure', 'cosmos db', 'bicep', 'azure functions'], iconUrl: 'https://api.iconify.design/logos:microsoft-azure.svg' },
  { key: 'microsoftexcel', label: 'Microsoft Excel', color: '217346', aliases: ['excel'], iconUrl: 'https://api.iconify.design/vscode-icons:file-type-excel.svg' },
  { key: 'microsoftaccess', label: 'Microsoft Access', color: 'A4373A', aliases: ['access'], iconUrl: 'https://api.iconify.design/vscode-icons:file-type-access.svg' },
  { key: 'flyway', label: 'Flyway', color: 'CC0200', aliases: ['flyway'] },
  { key: 'playwright', label: 'Playwright', color: '2EAD33', aliases: ['playwright'], iconUrl: 'https://api.iconify.design/logos:playwright.svg' },
  ...
  { key: 'amazonecs', label: 'AWS ECS', color: 'FF9900', aliases: ['aws ecs', 'amazon ecs'], iconUrl: 'https://api.iconify.design/logos:aws-ecs.svg' },
  { key: 'amazonsqs', label: 'Amazon SQS', color: 'FF4F8B', aliases: ['amazon sqs', 'aws sqs', 'sqs'], iconUrl: 'https://api.iconify.design/logos:aws-sqs.svg' },
  { key: 'datadog', label: 'Datadog', color: '632CA6', aliases: ['datadog'] },
  { key: 'apachekafka', label: 'Apache Kafka', color: '231F20', aliases: ['kafka'] },
  { key: 'openai', label: 'OpenAI / LLM', color: '412991', aliases: ['openai', 'azure openai', 'llm', 'rag'], iconUrl: 'https://api.iconify.design/logos:openai-icon.svg' },
  { key: 'langchain', label: 'LangChain', color: '1C3C3C', aliases: ['langchain', 'langgraph'] },
  { key: 'microsoftteams', label: 'Microsoft Teams', color: '6264A7', aliases: ['teams', 'teams sdk'], iconUrl: 'https://api.iconify.design/logos:microsoft-teams.svg' },
...
export function resolveSkillBadge(skillName: string, badgeKey?: string | null, badgeColor?: string | null) {
  ...
  return {
    ...
    iconUrl: option?.iconUrl ?? recommended?.iconUrl,
  };
}
