...
import { printTemplateApi, type PrintTemplate } from '../lib/api';
...
export function PrintModeModal({ open, onClose, onManual, onApplyTemplate }: PrintModeModalProps) {
  ...
  // 모달 열릴 때마다 1단계 메인 화면으로 리셋하고 localStorage에서 최신 값을 읽는다
  useEffect(() => {
    if (open) {
      setStep('MAIN');
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4" onClick={onClose}>
      ...
      >
        {/* Header — 상단 곡률과 완벽하게 조화를 이루는 pt-6 패딩 */}
        ...
        {/* Body — STEP 2: TEMPLATE_LIST (템플릿 목록 뎁스) */}
        {step === 'TEMPLATE_LIST' && (
                      ...
                      {localSaves.map((s) => (
                        ...
                        >
                          ...
                          <div className="flex items-center gap-1 shrink-0">
                            ...
                            <button
                              onClick={(e) => handleRemoveLocal(s.id, e)}
