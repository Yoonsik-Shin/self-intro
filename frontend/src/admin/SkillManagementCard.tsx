    ...
    <article className="flex min-h-36 flex-col rounded-xl border border-slate-200 bg-white p-3 shadow-sm transition hover:border-slate-300 hover:shadow-md">
      ...
      <div className="mt-1 flex min-w-0 items-center gap-2.5">
        ...
        <div className="min-w-0 flex-1">
          <h4 className="truncate text-base font-black leading-tight text-slate-900" title={skill.name}>{skill.name}</h4>
      ...
      <p className={`mt-2.5 line-clamp-2 text-xs font-medium leading-4 ${skill.comment ? 'text-slate-500' : 'italic text-slate-300'}`}>
