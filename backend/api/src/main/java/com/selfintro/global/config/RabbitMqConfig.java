...
public class RabbitMqConfig {
    ...
    public static final String QUEUE_JOB_POSTING_COLLECTED =
            "selfintro.queue.job-posting.collected";
    public static final String QUEUE_JOB_MATCHING_COMPLETED =
            "selfintro.queue.job-matching.completed";
    ...
    public Binding jobPostingCollectedBinding(
        ...
        return BindingBuilder.bind(jobPostingCollectedQueue)
                .to(eventExchange)
                .with(ROUTING_KEY_COLLECTED);
    }
    ...
    public Binding jobMatchingCompletedBinding(
            ...
            @Qualifier("eventExchange") TopicExchange eventExchange) {
        return BindingBuilder.bind(jobMatchingCompletedQueue)
                .to(eventExchange)
                .with(ROUTING_KEY_MATCHING);
    }
    ...
    public Binding experienceUpdatedBinding(
            ...
            @Qualifier("eventExchange") TopicExchange eventExchange) {
        return BindingBuilder.bind(experienceUpdatedQueue)
                .to(eventExchange)
                .with(ROUTING_KEY_EXPERIENCE_UPDATED);
    }
    ...
    public Binding studyUpdatedBinding(
            ...
            @Qualifier("eventExchange") TopicExchange eventExchange) {
        return BindingBuilder.bind(studyUpdatedQueue)
                .to(eventExchange)
                .with(ROUTING_KEY_STUDY_UPDATED);
    }
