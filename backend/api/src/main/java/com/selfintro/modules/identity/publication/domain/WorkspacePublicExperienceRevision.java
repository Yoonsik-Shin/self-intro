...
@Entity
@Table(name = "workspace_public_experience_revision")
@Getter
@NoArgsConstructor(access = AccessLevel.PROTECTED)
public class WorkspacePublicExperienceRevision {
    @Id
    ...
    public static WorkspacePublicExperienceRevision create(
            Long workspaceId,
            int revisionNumber,
            ...
            LocalDateTime now) {
        WorkspacePublicExperienceRevision revision = new WorkspacePublicExperienceRevision();
