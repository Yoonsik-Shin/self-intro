...
/**
 * 회사명/직무명을 정규화해 서로 다른 플랫폼(원티드/잡코리아/사람인 등)에 올라온 같은 공고를 완전일치로 매칭할 수 있게 한다. 직무명은 공백/대소문자 차이만 흡수하고 키워드는
 * 건드리지 않는다 — 다른 직무를 같은 공고로 오탐 병합하는 것을 막기 위해서다.
 */
public final class JobPostingNormalizer {
    ...
    /**
     * 플랫폼 간 직무명 표기 차이(예: "AI 개발 엔지니어" vs "AI 개발 엔지니어(신입/Java개발)")를 완화하여 중복 매칭에 사용하는 직무명 핵심 비교 키를
     * 생성한다.
     */
