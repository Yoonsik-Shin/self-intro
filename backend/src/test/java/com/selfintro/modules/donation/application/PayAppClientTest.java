...
class PayAppClientTest {
    ...
    void parsesSuccessResponse() {
        Map<String, String> parsed = PayAppClient.parse(
                "state=1&mul_no=12345678&payurl=https%3A%2F%2Fpayapp.kr%2FL%2Fabcdef");

        assertThat(parsed).containsEntry("state", "1")
    ...
    void parsesErrorResponse() {
        ...
        assertThat(parsed).containsEntry("state", "0")
                .containsEntry("errorMessage", "잘못된 요청");
    }
