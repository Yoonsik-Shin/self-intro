...
public class PrintTemplateController {
    ...
    public ResponseEntity<List<PrintTemplateResponse>> listPublic() {
        List<PrintTemplateResponse> list = printTemplateService.listPublic().stream()
    ...
    public ResponseEntity<List<PrintTemplateResponse>> listAll() {
        List<PrintTemplateResponse> list = printTemplateService.listAll().stream()
            .map(PrintTemplateResponse::from)
            .toList();
        return ResponseEntity.ok(list);
    }
    ...
    public ResponseEntity<PrintTemplateResponse> update(@PathVariable Long id, @Valid @RequestBody PrintTemplateRequest request) {
        return ResponseEntity.ok(PrintTemplateResponse.from(printTemplateService.update(id, request)));
    }
