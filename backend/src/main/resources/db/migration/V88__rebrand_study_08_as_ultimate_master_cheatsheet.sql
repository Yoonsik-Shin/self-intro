-- V88: Rebrand Study 8 into Ultimate Java Coding Test Master Cheat Sheet (시험장 필수 최종 치트시트)

SET NAMES utf8mb4 COLLATE utf8mb4_unicode_ci;

-- =========================================================================
-- Rebrand Study 8 -> Java 코딩테스트 시험장 필수 최종 치트시트 (Master Cheat Sheet)
-- =========================================================================
UPDATE study
SET title = 'Java 코딩테스트 시험장 필수 최종 치트시트 (Master Cheat Sheet)',
    summary = '시험장에 가기 전 3분 만에 훑어보는 자바 코딩테스트 필수 치트시트다. 입출력, 형변환, 정렬(원시/객체/2차원), 초기화, Stream API, 수학/비트 연산, 그리고 감점 방지 체크리스트를 총정리한다.',
    content_markdown = '# Java 코딩테스트 시험장 필수 최종 치트시트 (Master Cheat Sheet)
